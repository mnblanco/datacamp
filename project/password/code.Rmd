...
users <- read_csv("project/password/datasets/users.csv")
...
common_passwords <- read_lines("project/password/datasets/10_million_password_list_top_10000.txt")
...
words <- read_lines("project/password/datasets/google-10000-english.txt")
...
users$first_name <- str_extract(users$user_name, "^.+\\.") %>% str_replace("\\.", "")
users$last_name <- str_extract(users$user_name, "\\..+$") %>% str_replace("\\.", "")
