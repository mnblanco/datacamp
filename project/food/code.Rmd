...
# Plot the forecast
autoplot(cassava_price_forecast)
```
### Chili (red)
...
# Plot the forecast
autoplot(oranges_price_forecast)
```
### Sorghums
...
# Plot the forecast
autoplot(sorghum_price_forecast)
```
...
# Plot the forecast
autoplot(tomatoes_price_forecast)
```
